...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'bb3_oauth_tokens', 'bb3_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'bb3_users', $this, './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'bb3_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'bb3_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'bb3_forums', 'bb3_posts', 'bb3_topics', 'bb3_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('bb3_captcha_questions', 'bb3_captcha_answers', 'bb3_qa_confirm');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\db\driver\mysqli A phpbb\db\driver\mysqli instance.
     */
    protected function getDbal_Conn_DriverService()
    {
        $this->services['dbal.conn.driver'] = $instance = new \phpbb\db\driver\mysqli();

        $instance->sql_connect('localhost', 'dineshpartan', '!23456789o', 'bb3_discussions', '3306', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('vinny.shareon.listener', 'vinny\\shareon\\event\\listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'bb3_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'bb3_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'bb3_migrations', './', 'php', 'bb3_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'bb3_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'bb3_notification_types', 'bb3_notifications', 'bb3_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'bb3_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'bb3_profile_fields', 'bb3_profile_lang', 'bb3_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'bb3_users');
    }
    ...
    /**
     * Gets the 'vinny.shareon.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vinny\shareon\event\listener A vinny\shareon\event\listener instance.
     */
    protected function getVinny_Shareon_ListenerService()
    {
        return $this->services['vinny.shareon.listener'] = new \vinny\shareon\event\listener($this->get('controller.helper'), $this->get('template'), $this->get('config'), './', 'php');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'bb3_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'bb3_oauth_accounts',
            'tables.captcha_qa_questions' => 'bb3_captcha_questions',
            'tables.captcha_qa_answers' => 'bb3_captcha_answers',
            'tables.captcha_qa_confirm' => 'bb3_qa_confirm',
            'tables.config' => 'bb3_config',
            'tables.config_text' => 'bb3_config_text',
            'tables.ext' => 'bb3_ext',
            'tables.forums' => 'bb3_forums',
            'tables.log' => 'bb3_log',
            'tables.migrations' => 'bb3_migrations',
            'tables.modules' => 'bb3_modules',
            'tables.notification_types' => 'bb3_notification_types',
            'tables.notifications' => 'bb3_notifications',
            'tables.profile_fields' => 'bb3_profile_fields',
            'tables.profile_fields_data' => 'bb3_profile_fields_data',
            'tables.profile_fields_options_language' => 'bb3_profile_fields_lang',
            'tables.profile_fields_language' => 'bb3_profile_lang',
            'tables.posts' => 'bb3_posts',
            'tables.topics' => 'bb3_topics',
            'tables.user_notifications' => 'bb3_user_notifications',
            'tables.users' => 'bb3_users',
            ...
            'core.table_prefix' => 'bb3_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysqli',
            'dbal.dbhost' => 'localhost',
            'dbal.dbuser' => 'dineshpartan',
            'dbal.dbpasswd' => '!23456789o',
            'dbal.dbname' => 'bb3_discussions',
            'dbal.dbport' => '3306',
            'dbal.new_link' => false,
        );
    }
