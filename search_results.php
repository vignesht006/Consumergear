...
$i=1;	
   ...
   <?php
   $qry="select image_path from sub_categories where find_in_set(".$_GET['cat'].", parent)";
   $ban=mysqli_query($con,$qry);
...
<ul class="list-group">
  <li class="list-group-item" data-toggle="collapse" data-target="#mny" >BUDGET<span class="fa fa-chevron-down pull-right"></span></li>
 ...
 $custom_filter=mysqli_query($con,"select * from filters where find_in_set('".$_GET['cat']."', category) and status=1");
...
VISIT WEBSITE</button></p><p><img src="app/'.$row['logo_path'].'"  class="img-thumbnail" alt="No logo"  width="285px" height="135" ></p>
