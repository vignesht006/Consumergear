...
if($file_path1 !='')
{
	...
	$sql="update backgrounds set image_name='".$main_image_name."', image_path='".$file_path1."' , type='0' where id=1";

}
else
{
	$fname='';
	$sql="update backgrounds set  image_path='".$url."' , type='1' where id=1";
}
